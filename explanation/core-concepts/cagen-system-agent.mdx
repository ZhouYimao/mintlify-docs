...
<Info>
  **Action 0** is Cagen's superpower—the ability to execute any action using Claude Code as the execution engine. Think of it as having a universal remote control for your entire development and business ecosystem.
</Info>

### What Makes Action 0 Special

**Action 0** is fundamentally different from other actions:
...
<Tip>
  **Pro tip**: Shift+Tab is your secret weapon for instant action execution. No waiting, no confirmation—just immediate results.
</Tip>
